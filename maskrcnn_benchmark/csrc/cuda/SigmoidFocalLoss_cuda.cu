...
at::Tensor SigmoidFocalLoss_forward_cuda(
  ...
  dim3 grid(std::min(at::cuda::ATenCeilDiv(static_cast<int64_t>(losses_size), static_cast<int64_t>(512)), static_cast<int64_t>(4096)));
  dim3 block(512);
...
at::Tensor SigmoidFocalLoss_backward_cuda(
  ...
  dim3 grid(std::min(at::cuda::ATenCeilDiv(static_cast<int64_t>(d_logits_size), static_cast<int64_t>(512)), static_cast<int64_t>(4096)));
  dim3 block(512);
