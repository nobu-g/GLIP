...
class CocoDetectionTSV(ODTSVDataset):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(yaml_file, extra_fields, **kwargs)
    ...
    def __getitem__(self, idx):
        # tgt is a BoxList
        img, target, _, scale = super().__getitem__(idx)
        ...
        if len(target) < original_box_num:
            print(f"WARNING: removed {original_box_num - len(target)} boxes due to positive caption overflow")
